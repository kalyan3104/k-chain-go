...
import (
	...
	"github.com/kalyan3104/k-chain-go/node/chainSimulator/components"
	...
	kChainSharding "github.com/kalyan3104/k-chain-go/sharding"
...
func generateAddressInShard(shardCoordinator kChainSharding.Coordinator, len int) []byte {
	for {
