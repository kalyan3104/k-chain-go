...
import (
	...
	"github.com/kalyan3104/k-chain-go/cmd/assessment/benchmarks"
	"github.com/kalyan3104/k-chain-go/cmd/assessment/benchmarks/factory"
	"github.com/kalyan3104/k-chain-go/common/hostParameters"
...
func main() {
	...
	app.Name = "Kalyan Node Assessment Tool"
	...
	app.Usage = "This tool is used to measure the host's performance on some certain tasks used by a Kalyan node. It " +
