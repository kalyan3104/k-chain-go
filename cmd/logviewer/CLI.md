...
NAME:
   Kalyan Logviewer App - Logviewer application used to communicate with k-chain-go node to log the message lines
USAGE:
...
GLOBAL OPTIONS:
   --address value            Address and port number on which the application will try to connect to the k-chain-go node (default: "127.0.0.1:8080")
