//go:generate protoc -I=. -I=$GOPATH/src -I=$GOPATH/src/github.com/kalyan3104/protobuf/protobuf  --gogoslick_out=. miniblockMetadata.proto
...
import (
	...
	"github.com/kalyan3104/k-chain-core-go/core/container"
	...
	"github.com/kalyan3104/k-chain-go/common/logging"
