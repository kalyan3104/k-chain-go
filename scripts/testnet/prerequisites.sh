...
git clone git@github.com:kalyan3104/k-chain-deploy-go.git
git clone git@github.com:kalyan3104/k-chain-proxy-go.git


if [[ $PRIVATE_REPOS -eq 1 ]]; then
  git clone git@github.com:kalyan3104/k-chain-txgen-go.git
  cd k-chain-txgen-go
  git checkout master
fi
