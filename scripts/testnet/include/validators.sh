source "$KALYANTESTNETSCRIPTSDIR/include/terminal.sh"

startValidators() {
  setTerminalSession "kalyan-nodes"
...
assembleCommand_startValidatorNodeWithWatcher() {
  ...
  local source_command="source $KALYANTESTNETSCRIPTSDIR/include/watcher.sh"
