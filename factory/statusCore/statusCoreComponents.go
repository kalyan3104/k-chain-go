...
import (
	...
	"github.com/kalyan3104/k-chain-go/common/statistics/machine"
	...
	"github.com/kalyan3104/k-chain-go/statusHandler/persister"
...
func checkArgs(args StatusCoreComponentsFactoryArgs) error {
	if check.IfNil(args.CoreComp) {
		return errorsk.ErrNilCoreComponents
	}
	if check.IfNil(args.CoreComp.EconomicsData()) {
		return errorsk.ErrNilEconomicsData
	}
