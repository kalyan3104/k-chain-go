...
func TestNewHeartbeatV2ComponentsFactory(t *testing.T) {
	...
	t.Run("nil BootstrapComponents should error", func(t *testing.T) {
		...
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilBootstrapComponentsHolder, err)
	})
	t.Run("nil CoreComponents should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilCoreComponentsHolder, err)
	})
	t.Run("nil DataComponents should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilDataComponentsHolder, err)
	})
	t.Run("nil DataPool should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilDataPoolsHolder, err)
	})
	t.Run("nil NetworkComponents should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilNetworkComponentsHolder, err)
	})
	t.Run("nil NetworkMessenger should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.True(t, errors.Is(err, errorsk.ErrNilMessenger))
	})
	...
	t.Run("nil CryptoComponents should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilCryptoComponentsHolder, err)
	})
	t.Run("nil ProcessComponents should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilProcessComponentsHolder, err)
	})
	t.Run("nil EpochStartTrigger should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilEpochStartTrigger, err)
	})
	t.Run("nil StatusCoreComponents should error", func(t *testing.T) {
		...
		hcf, err := heartbeatComp.NewHeartbeatV2ComponentsFactory(args)
		assert.Nil(t, hcf)
		assert.Equal(t, errorsk.ErrNilStatusCoreComponents, err)
	})
}
...
func TestHeartbeatV2Components_Create(t *testing.T) {
	...
	t.Run("invalid config should error", func(t *testing.T) {
		...
		hc, err := hcf.Create()
		assert.Nil(t, hc)
		assert.True(t, errors.Is(err, errorsk.ErrInvalidHeartbeatV2Config))
	})
