...
func TestNewManagedConsensusComponents(t *testing.T) {
	...
	t.Run("nil factory should error", func(t *testing.T) {
		...
		require.Equal(t, errorsk.ErrNilConsensusComponentsFactory, err)
...
func TestManagedConsensusComponents_ConsensusGroupSize(t *testing.T) {
	...
	require.Equal(t, errorsk.ErrNilConsensusComponentsHolder, err)
	require.Zero(t, size)
...
func TestManagedConsensusComponents_CheckSubcomponents(t *testing.T) {
	...
	require.Equal(t, errorsk.ErrNilConsensusComponentsHolder, managedConsensusComponents.CheckSubcomponents())
