...
import (
	...
	retriever "github.com/kalyan3104/k-chain-go/dataRetriever"
	errorsk "github.com/kalyan3104/k-chain-go/errors"
	consensusComp "github.com/kalyan3104/k-chain-go/factory/consensus"
	...
	consensusMocks "github.com/kalyan3104/k-chain-go/testscommon/consensus"
	...
	outportMocks "github.com/kalyan3104/k-chain-go/testscommon/outport"
	"github.com/kalyan3104/k-chain-go/testscommon/p2pmocks"
	"github.com/kalyan3104/k-chain-go/testscommon/shardingMocks"
	stateMocks "github.com/kalyan3104/k-chain-go/testscommon/state"
...
func TestNewConsensusComponentsFactory(t *testing.T) {
	...
	t.Run("nil GenesisNodesSetup should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilGenesisNodesSetupHandler, err)
	})
	t.Run("nil DataComponents should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilDataComponentsHolder, err)
	})
	t.Run("nil Datapool should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilDataPoolsHolder, err)
	})
	t.Run("nil BlockChain should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilBlockChainHandler, err)
	})
	...
	t.Run("nil PublicKey should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilPublicKey, err)
	})
	t.Run("nil PrivateKey should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilPrivateKey, err)
	})
	...
	t.Run("nil Messenger should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilMessenger, err)
	})
	t.Run("nil ProcessComponents should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilProcessComponentsHolder, err)
	})
	t.Run("nil NodesCoordinator should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilNodesCoordinator, err)
	})
	t.Run("nil ShardCoordinator should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilShardCoordinator, err)
	})
	t.Run("nil RoundHandler should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilRoundHandler, err)
	})
	t.Run("nil HardforkTrigger should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilHardforkTrigger, err)
	})
	t.Run("nil StateComponents should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilStateComponentsHolder, err)
	})
	t.Run("nil StatusComponents should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilStatusComponentsHolder, err)
	})
	t.Run("nil OutportHandler should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilOutportHandler, err)
	})
	t.Run("nil ScheduledProcessor should error", func(t *testing.T) {
		...
		require.Nil(t, ccf)
		require.Equal(t, errorsk.ErrNilScheduledProcessor, err)
	})
...
func TestConsensusComponentsFactory_Create(t *testing.T) {
	...
	t.Run("genesis block not initialized should error", func(t *testing.T) {
		...
		cc, err := ccf.Create()
		require.Equal(t, errorsk.ErrGenesisBlockNotInitialized, err)
		require.Nil(t, cc)
	})
	...
	t.Run("createUserAccountsSyncer fails due to missing UserAccountTrie should error", func(t *testing.T) {
		...
		cc, err := ccf.Create()
		require.Equal(t, errorsk.ErrNilTrieStorageManager, err)
		require.Nil(t, cc)
	})
