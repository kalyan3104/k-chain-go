...
import (
	...
	"github.com/kalyan3104/k-chain-go/heartbeat/mock"
...
func TestPeerAuthenticationSender_execute(t *testing.T) {
	...
	t.Run("should work with some real components", func(t *testing.T) {
		...
		startTime := time.Now()
		// use the Kalyan defined ed25519 operations instead of the secp256k1 implemented in the "real" network messenger,
